...
def main():
    ...
    parser.add_argument('--input_training_file', default='/data_mnt/aishell3/train/hifi_train.txt')
    parser.add_argument('--input_validation_file', default='/data_mnt/aishell3/test/hifi_test.txt')
    parser.add_argument('--checkpoint_path', default='aishell3')
